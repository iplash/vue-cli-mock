  ...
  <div class="app-container">
    <div class="filter-container">
      ...
      <el-select
        ...
        @change="changeType"
      >
        <el-option key="add" label="增加积分" value="add"/>
        <el-option key="sub" label="消费积分" value="sub"/>
      </el-select>
      <el-date-picker
    ...
    <el-table v-loading="listLoading" :data="list" border style="width: 100%">
      ...
      <el-table-column prop="outTradeNumber" label="订单编号" align="center"></el-table-column>
      <el-table-column prop="appName" label="平台" align="center"></el-table-column>
      <el-table-column prop="describtion" label="积分类型" align="center"></el-table-column>
      <el-table-column prop="createTime" label="交易时间" align="center" :formatter="formatTime"></el-table-column>
      <el-table-column
        prop="points"
        :label="listQuery.type === 'add' ? '收入积分' : '消费积分'"
        align="center"
      ></el-table-column>
      <el-table-column prop="totalFee" label="剩余积分" align="center"></el-table-column>
    </el-table>
  </div>
</template>

<script>
import { getAllAuthList, getMinusPoints } from "@/api/points";
  ...
  methods: {
    getList() {      
      ...
      const query = time
        ...
        : { ...this.listQuery };
      getMinusPoints(query).then(response => {
